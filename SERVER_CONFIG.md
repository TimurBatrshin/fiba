...
Данный документ содержит инструкции по настройке веб-сервера для корректной работы приложения FIBA 3x3 версии 1.6.3 и выше.
...
```
/var/www/html/apps/FIBA3x3/1.6.3/ - файлы версии 1.6.3
/var/www/html/apps/FIBA3x3/1.6.2/ - файлы версии 1.6.2
...
location /fiba {
    alias /var/www/html/apps/FIBA3x3/1.6.3/;
...
1. Загрузите файлы в новую директорию, соответствующую номеру версии (например, `/var/www/html/apps/FIBA3x3/1.6.4/`)
